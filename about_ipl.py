...
def app():
    ...
    with col2:
        ...
        intro = st.container()
        intro.write("The Indian Premier League (IPL) is a Twenty-20 cricket tournament league established with the "
                    ...
                    "other.")
        intro.image(f"data:image/png;"
                    f"base64,{image_to_bytes('WebsiteImages/intro_bcci_logo.png')}")
        intro.write("It was started by the Board of Control for Cricket in India (BCCI) in 2008 and has now become a "
                    "giant, remunerative cricket venture. The teams for IPL are selected by means of an auction.")
        intro.subheader("")
        intro.subheader("")

        body1 = st.container()
        body1.subheader("Teams in IPL")
        body1.write("Teams of IPL are:- ")
        body1.write("Royal Challengers Bangalore, Kings XI Punjab, Delhi Daredevils, Mumbai Indians, Kolkata Knight "
        ...
        body1.image(f"data:image/png;"
                    f"base64,{image_to_bytes('WebsiteImages/body1_teams_logo.png')}")
        body1.write("The owners of the IPL franchises, includes major companies, Bollywood film stars, and media "
                    "moguls. The IPL is the most-attended cricket league in the world.")
        body1.write("Due to the involvement of money, team spirit, city loyalty and a massive fan following, "
        ...
        body1.write("A report from Duff & Phelps said that one of the contributing factors in the rapid growth of the "
        ...
        body1.write("The IPL is the most-attended cricket league in the world and in 2014 was ranked sixth by average "
        ...
        body1.write("From 2008 to 2012, the title sponsor was DLF, India's largest real estate developer, "
        ...
        body2 = st.container()
        body2.subheader("Team's Performance")
        body2.write("Out of the thirteen teams that have played in the Indian Premier League since its inception, "
                    ...
                    "fourth title.")
        body2.image(f"data:image/png;"
                    f"base64,{image_to_bytes('WebsiteImages/body2_winnings_logo.png')}")
        body2.subheader("")
        body2.subheader("")

        conclusion = st.container()
        conclusion.subheader("Orange Cap")
        conclusion.write("The Orange Cap is awarded to the top run-scorer in the IPL during a season. It is an "
        ...
        conclusion.subheader("Purple Cap")
        conclusion.write("The Purple Cap is awarded to the top wicket-taker in the IPL during a season. It is an "
                         "ongoing competition with the leader wearing the cap throughout the tournament until the "
                         "final game, with the eventual winner keeping the cap for the season. Latest winner – "
                         "Harshal Patel - 32 wickets (2021).")
        conclusion.subheader("Most Valuable Player")
        conclusion.write('The award was called the "man of the tournament" till the 2012 season. The IPL introduced '
        ...
        conclusion.subheader("Fairplay Award")
        conclusion.write("The Fair Play Award is given after each season to the team with the best record of fair "
        ...
        conclusion.subheader("Emerging Player Award")
        conclusion.write('The award was presented for the "best under-19 player" in 2008 and "best under-23 player" '
        ...
        conclusion.subheader("Most sixes Award")
        conclusion.write("The Maximum Sixes Award, currently known as Unacademy Let's Crack It Sixes Award for "
